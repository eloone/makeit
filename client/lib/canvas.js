...
/**
    ...
    @class
*/
VisualGameObject = function VisualGameObject()
{
    /**
...
/**
    ...
    @class
*/
RepeatingGameObject = function RepeatingGameObject()
{
...
/**
    ...
    @class
*/
AnimatedGameObject = function AnimatedGameObject()
{
    /**
...
ApplicationManager = function ApplicationManager()
{
    /**
        ...
        @return A reference to the initialised object
    */
    this.startupApplicationManager = function(g_run, cTotalFrames, FPS)
    {
...
/**
    ...
    @class
*/
GameObjectManager = function GameObjectManager()
{
    ...
    */
    ...
    /**
        ...
        @return A reference to the initialised object
    */
    this.startupGameObjectManager = function(g_run, cTotalFrames, FPS)
    {
        ...
        this.applicationManager = new ApplicationManager().startupApplicationManager(g_run, cTotalFrames, FPS);
...
initCanvas = function initCanvas(g_run, cTotalFrames, FPS)
{
    new GameObjectManager().startupGameObjectManager(g_run, cTotalFrames, FPS);
};